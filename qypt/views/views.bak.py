...
def itemEdit(request):
    ...
    if isLogin(request):
        ...
        param1 = {"admintel": admintel, "item":itemobj, "itemid": itemobj.id, "shopselectid": itemobj.shop.id, "img1Url": img1Url, "img2Url": img2Url, "img3Url":img3Url}
